...
export const DEF_EDIT_ERRORS: Record<string, string> = {
  ...
  "codex-only-v0.7": "이 스킬은 .agents(codex) 전용입니다 · .claude 정의 편집은 v0.7 비대상입니다.",
  ...
  "proposal-not-available": "평가 제안 적용 경로는 아직 사용할 수 없습니다(F8 · M13 이후).",
...
export const INTEGRITY_DETAIL: Record<string, string> = {
  ...
  "name-changed": "name 은 변경할 수 없습니다(리네임 금지 · v0.7 비대상).",
